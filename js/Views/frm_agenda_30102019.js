...
function guardarnovoevento(calEvent){
	...
	if (tabela==="mx"){
		...
		var query = "insert into mx (mxstamp,data,hinicio,hfim,inicio,fim,clnome,texto,nkeyid,ckeyid,tecnico,tecnnm,clno,clestab,morada,local,codpost,vendedor,vendnm,username,userno,tusername,tuserno,origem,u_naoconf,u_emcasa,u_reminder,u_fref,u_tipomx,ousrinis,ousrdata,ousrhora,usrinis,usrdata,usrhora)"
